          ...
          >
            ...
            <CardContent className="p-4 space-y-4">
              ...
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1 bg-yellow-100 text-sm rounded-md">
                  {event.organizer}
                </span>
                <span className="px-3 py-1 bg-yellow-100 text-sm rounded-md">
                  {event.location}
              ...
              {/* Date / Time */}
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1 bg-gray-100 text-xs rounded-md flex items-center gap-1">
              ...
              <div className="flex gap-2 pt-3">
                <Button
                  variant="outline"
                  className="w-full bg-yellow-400 text-black hover:bg-yellow-500 mt-2"
                >
                  View Details
                </Button>
              </div>
