...
export function TopNavbar({ onMenuClick, isCollapsed }: NavbarProps) {
  ...
  <div className="space-y-1">
    <Link
      href="/user/portfolio"
      className="w-full flex items-center gap-3 px-3 py-2.5 text-sm text-foreground hover:bg-accent/80 rounded-xl transition-all duration-300 hover:scale-[1.02] group"
    >
    ...
    <Link
      href="/logout"
      className="w-full flex items-center gap-3 px-3 py-2.5 text-sm text-red-500 hover:bg-red-500/10 rounded-xl transition-all duration-300 hover:scale-[1.02] group"
    >
