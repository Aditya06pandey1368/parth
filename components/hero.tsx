          ...
          <div className="container mx-auto grid min-h-[calc(100vh-80px)] items-center px-6 lg:grid-cols-2 gap-16 lg:gap-8">
            <div className="flex flex-col gap-8 text-center lg:text-left">
              ...
              <p className="text-lg text-gray-600 max-w-xl mx-auto lg:mx-0">
                Parth empowers students to track, verify, and showcase their academic and extracurricular achievements, building a trusted digital portfolio that opens doors to internships, jobs, and institutional accreditations </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <Link href="#" className="px-8 py-4 text-base font-bold rounded-full bg-[#f9a806] text-white hover:bg-yellow-400 transition-transform transform hover:scale-105">Onboard Your College</Link>
