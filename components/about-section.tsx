...
function AboutSection() {
  return (
    <div>
      ...
      <section className="relative bg-light-yellow dark:bg-gray-900 pt-24 pb-20 md:pt-32 md:pb-28 overflow-hidden">
        <div className="container mx-auto px-6 text-center">
          ...
          <motion.h1
            ...
            className="text-4xl md:text-6xl font-extrabold leading-tight tracking-tight mt-4 text-dark-gray dark:text-gray-100"
          >
            Empowering Student Journeys, <br /> One{" "}
            {/* Adjusted typewriter text color for better dark mode contrast */}
          ...
          <motion.p
            ...
            className="mt-6 text-lg md:text-xl max-w-3xl mx-auto text-medium-gray dark:text-gray-400"
          >
      ...
      {/* Section with gradient background and content */}
      {/* Swapped light gradient for a dark one in dark mode */}
      <section className="relative py-24 bg-gradient-to-br from-yellow-50 via-white to-yellow-100 dark:from-gray-800 dark:via-gray-900 dark:to-black overflow-hidden">
        {/* Floating Gradient Background Circles */}
        {/* Changed mix-blend-multiply to mix-blend-screen for a glowing effect in dark mode */}
        <motion.div
          animate={{ scale: [1, 1.1, 1] }}
          transition={{ repeat: Infinity, duration: 6 }}
          className="absolute top-0 -left-16 w-72 h-72 bg-yellow-200 rounded-full mix-blend-multiply dark:mix-blend-screen filter blur-3xl opacity-30 dark:opacity-10"
        ></motion.div>
        <motion.div
          animate={{ scale: [1, 1.1, 1] }}
          transition={{ repeat: Infinity, duration: 7, delay: 1 }}
          className="absolute bottom-0 -right-16 w-72 h-72 bg-yellow-300 rounded-full mix-blend-multiply dark:mix-blend-screen filter blur-3xl opacity-30 dark:opacity-10"
        ></motion.div>
        ...
        <div className="container relative mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
          ...
          <motion.div
            ...
            className="relative group rounded-2xl overflow-hidden shadow-2xl dark:shadow-lg dark:shadow-yellow-500/10"
          >
            <Image
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900 dark:text-gray-100 leading-tight">
              Who <span className="text-yellow-500 dark:text-yellow-400">We Are</span>
            </h2>
