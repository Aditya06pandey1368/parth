              ...
              <div className="space-y-12">
                ...
                >
                  <div className="absolute left-0 top-0 w-12 h-12 rounded-full bg-[#f9a806] flex items-center justify-center ring-8 ring-gray-50 transform transition-all duration-500 ease-out group-hover:scale-110 group-hover:rotate-12 group-hover:shadow-lg group-hover:shadow-[#f9a806]/30">
                    <svg
                      className="h-6 w-6 text-white transform transition-transform duration-300 group-hover:scale-110"
                      fill="none"
                      stroke="currentColor"
                      strokeWidth="2"
                      viewBox="0 0 24 24"
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-2 transform transition-all duration-300 group-hover:text-[#f9a806] group-hover:translate-x-2">
                    For Students
                  </h3>
                  <p className="text-gray-600 transform transition-all duration-300 group-hover:text-gray-800 group-hover:translate-x-1">
                ...
                {[
                  {
                    icon: (
                      <svg
                        className="h-6 w-6 text-gray-600 group-hover:text-[#f9a806] transition-colors duration-300"
                        fill="none"
                        stroke="currentColor"
                        strokeWidth="1.5"
                        viewBox="0 0 24 24"
                  ...
                  },
                  {
                    icon: (
                      <svg
                        className="h-6 w-6 text-gray-600 group-hover:text-blue-500 transition-colors duration-300"
                        fill="none"
                        stroke="currentColor"
                        strokeWidth="1.5"
                        viewBox="0 0 24 24"
                  ...
                  >
                    ...
                    <h4 className="font-semibold text-gray-800 transform transition-all duration-300 group-hover:text-gray-900 group-hover:translate-x-2">
                      {item.title}
                    </h4>
                    <p className="text-sm text-gray-500 transform transition-all duration-300 group-hover:text-gray-700 group-hover:translate-x-1">
                      {item.description}
                    </p>
                  </div>
                ))}
              ...
              <div className="space-y-12">
                ...
                {[
                  ...
                  },
                  {
                    icon: (
                      <svg
                        className="h-6 w-6 text-gray-600 group-hover:text-purple-500 transition-colors duration-300"
                        fill="none"
                        stroke="currentColor"
                        strokeWidth="1.5"
                        viewBox="0 0 24 24"
                  ...
                  },
                  {
                    icon: (
                      <svg
                        className="h-6 w-6 text-gray-600 group-hover:text-indigo-500 transition-colors duration-300"
                        fill="none"
                        stroke="currentColor"
                        strokeWidth="1.5"
                        viewBox="0 0 24 24"
            ...
            >
              <div className="container mx-auto px-6 text-center">
                <div className="w-full px-2 sm:px-6 text-center">
                  <div className="relative w-full max-w-4xl mx-auto rounded-2xl overflow-hidden shadow-2xl group cursor-pointer transform transition-all duration-700 ease-out hover:scale-105 hover:shadow-3xl hover:shadow-[#f9a806]/20">
                    <video
                      className="w-full rounded-2xl block transform transition-all duration-500 ease-out group-hover:scale-110"
                      controls
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-[#f9a806]/30 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-all duration-500 ease-out"></div>
